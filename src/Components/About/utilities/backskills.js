        ...
        <div className="model-container">
            ...
            <div className='projects'>
                <div className='project'>
                    <div>
                        <h2 className='bg-black pl-10 text-white'>Book Store</h2><br />
                        <p style={{ width: "35rem" }}>
                ...
                <div className='project'>
                    <div>
                        <h2  className='bg-black pl-10 text-white'>RegistrationForm</h2><br />
                        <p style={{ width: "35rem" }}>
                ...
                <div className='project'>
                    <div>
                        <h2  className='bg-black pl-10 text-white'>BankingApplication</h2><br />
                ...
                <div className='project'>
                    <div>
                        <h2 className='bg-black pl-10 text-white'>Weather App</h2><br />
                        <p style={{ width: "35rem" }}>
